...
import decision from './img/decision.png';
import protection from './img/protection.png';
import technicalities from './img/technicalities.png';
...
const championships = [
  {
    ...
    progress: 100,
    children: {type: 'champWeights', ids: [0, 1, 2, 3]},
  },
  {
    id: 1,
    type: 'championships',
...
const kpis = [
  ...
  },
  {
    ...
    icon: {value: confidence, pack: 'img'},
    progress: 84,
    type: 'kpis',
    children: {
      type: 'metrics',
  ...
  {
    id: 15,
    name: 'Position On Court',
    icon: {value: position, pack: 'img'},
    progress: 74,
    type: 'kpis',
    children: {
      type: 'metrics',
  ...
  },
  {
    id: 16,
    name: 'Technicalities',
    icon: {value: technicalities, pack: 'img'},
    progress: 70,
    type: 'kpis',
    children: {
      type: 'metrics',
  ...
  {
    id: 18,
    name: 'Protecting Player Safety',
    icon: {value: protection, pack: 'img'},
    progress: 95,
    type: 'kpis',
    children: {
      type: 'metrics',
...
const referees = [
  {
    ...
    icon: referee1,
    progress: 70,
    children: {type: 'kpis', ids: [4, 14, 15, 16, 17, 18]},
    isFullWidth: true,
  },
  {
    id: 1,
